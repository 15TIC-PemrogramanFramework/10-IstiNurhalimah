...
<br>
    ...
    <!-- jQuery -->
    <script src="<?php echo base_url() ?>assets/admin/baru/jquery/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo base_url() ?>assets/admin/baru/bootstrap/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="<?php echo base_url() ?>assets/admin/baru/metisMenu/metisMenu.min.js"></script>
